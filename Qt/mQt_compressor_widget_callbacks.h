...
void Compressor_widget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_attack_slider_valueChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->on_release_slider_valueChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->on_bypass_toggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: _t->on_load_button_pressed(); break;
        case 4: _t->on_save_button_pressed(); break;
        default: ;
        }
    }
}
